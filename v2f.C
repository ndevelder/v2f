...
{	
	return cL1_*max(min(pow(k_+k0_, 1.5)/(epsilon_ + epsilonSmall_),pow((k_+k0_),1.5)/(2.45*cMu_*v2_*sqrt(2.0*magSqr(dev(symm(uGrad_)))))),cL2_*pow(pow3(nu())/(epsilon_ + epsilonSmall_),0.25));
}
